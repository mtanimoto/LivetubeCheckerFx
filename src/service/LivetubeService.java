...
public class LivetubeService extends TableViewService {

    public LivetubeService( TableView<MainTableViewData> tableView
    ...
    public void draw() {
        ...
        // グリッド用のデータを作成
        ObservableList<MainTableViewData> livetubeData = LivetubeChannel.request();
